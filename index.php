...
define("BDUSS", "lBV29jTno1QUhoWU5RSFN6cW9vMnhNRlJMTFJsUjNqQ0c3cjFNWTZ5TjJlcmRmSUFBQUFBJCQAAAAAAAAAAAEAAADj1Q6gaHBiYXV1AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAHbtj1927Y9fME");
define("STOKEN", "91e2b0f9cf9d2c0bab4b3b6373e0b7e9169de0fc067cf0bd0456f2d6c332e10f");
$setpassword="0000";
...
<head>
    ...
    <meta name="author" content="雪风YUKI" />
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collpase-bar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://wwa.lanzous.com/iUnBdfm4uab" target="_blank">IDM下载</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.baidu.com/" target="_blank">雪风YUKI</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <?php } elseif (isset($_POST["surl"])) {
            if (empty($_POST["password"]) or $_POST["password"] != $setpassword) {
                ...
                echo '<script>sweetAlert("tips","请勿将软件传给他人，目前仅供群内自己人使用\r\n——雪风YUKI","info")</script>';
            }
            $surl = $_POST["surl"];
            $pwd = $_POST["pwd"];
